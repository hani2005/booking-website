    ...
    <div className="container">
      <UserContextProvider>
        <Routes>
          ...
          <Route path="/:id/success" element={<CarDetails />} />
          <Route path="/:id/cancel" element={<CarDetails />} />
          <Route path="/:id/success" element={<Experience />} />
          <Route path="/:id/cancel" element={<Experience />} />
